...
const departmentOptions = [
    ...
    { value: "CHEMICAL_ENGINEERING_AND_MATERIALS_SCIENCE", label: "Chemical Engineering And Materials Science" },
    { value: "CHEMISTRY_AND_CHEMICAL_BIOLOGY", label: "Chemistry And Chemical Biology" },
    { value: "CIVIL_ENVIRONMENTAL_AND_OCEAN_ENGINEERING", label: "Civil Environmental And Ocean Engineering" },
    { value: "COMPUTER_SCIENCE", label: "Computer Science" },
    { value: "ELECTRICAL_AND_COMPUTER_ENGINEERING", label: "Electrical And Computer Engineering" },
                            ...
                            <div className="row">
                                ...
                                <div className="col-3 my-auto">
                                    <input type="text" className="form-control" id="searchTerm"
                                           placeholder="Search by Project Name" onChange={(e) => setSearchTerm(e.target.value)} value={searchTerm}/>
                                </div>
                                <div className="col-3 my-auto">
                                    <select className="form-select" aria-label="Default select example" onChange={(e) => setSelectedDepartment(e.target.value)}>
                                ...
                                <ul className="chat-list">
                                    {projects
                                        ...
                                        >
                                            ...
                                            <p>{departmentOptions.find((department) => department.value === project.department).label}</p>
                                        </li>
                                    ))}
                                </ul>
                            </div>
