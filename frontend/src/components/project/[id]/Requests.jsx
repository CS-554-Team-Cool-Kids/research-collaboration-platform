...
const Requests = () => {
    ...
    const [fetchUserById, {loading: userLoading, error, data: userData}] = useLazyQuery(queries.GET_USER_BY_ID, {
                        ...
                        data.getProjectById.applications
                            ...
                            .map((application) => (
                                <div key={application._id} className="row mt-3">
                                    <div className="col my-auto request-name" onClick={() => handleClick(application)}>
    ...
    return (
        <div>
            {applicantDetails && (
                ...
                >
                    <div
                        className="modal-header p-2 text-white d-flex justify-content-between align-items-center">
                        <h5 className="modal-title">{applicantDetails.firstName} {applicantDetails.lastName}</h5>
                        <button className="btn-close invertColor" onClick={onClose}></button>
                    </div>
                    ...
                    <div className="modal-body p-2">
                        ...
                        <ul className="list-group">
                            ...
                            <li className="list-group-item">
                                <strong>Bio:</strong> {applicantDetails?.bio || "No Bio Available" }
                            </li>
                        </ul>
